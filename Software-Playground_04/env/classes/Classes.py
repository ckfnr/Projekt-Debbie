...
class ServoWrapper:
    ...
    def __init__(self, servo: Servo) -> None:
        ...
        self._servo_angle: int = self._servo.angle
...
class Coordinate:
    ...
    def get_difference(self, other: "Coordinate") -> float: return self.get_avg() - other.get_avg()

    # Adding values to xyz
    def add_x(self, value: float) -> None: self.x += value
