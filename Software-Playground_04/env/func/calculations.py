...
def calc_servo_angles(coordinate: Coordinate) -> dict[Literal["thigh", "lower-leg", "side-axis"], int]:
    ...
    l12: float =      _sqrt(coordinate.x**2 + z2D**2)
    ...
    alpha: float =    theta_2 - theta_1 + config.epsilon - 90                                            # Thigh
    theta_7: float =  theta_6 + theta_5 + alpha - config.epsilon
    ...
    beta: float =     theta_12 + theta_11 - 135                                                          # Lower leg
    gamma: float =    _atan(coordinate.y / coordinate.z)                                                 # Side axis
