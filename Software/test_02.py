...
while True:
    rf_ll = movement.leg_right_front.lower_leg.move(target_angle=60, duration=2)   # Set the angle of the lower_leg servo to 50 degrees (duration = 2 seconds)
    rb_ll = movement.leg_right_back.lower_leg.move(target_angle=60, duration=2)
    lf_ll = movement.leg_left_front.lower_leg.move(target_angle=60, duration=2)
    lb_ll = movement.leg_left_back.lower_leg.move(target_angle=60, duration=2)
